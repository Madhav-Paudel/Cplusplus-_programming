...
public:
    ...
    void calculation_part(int* hr1, int* min1, int* sec1, 
                          int* hr2, int* min2, int* sec2, 
                          int* totalhr, int* totalmin, int* totalsec) {
    ...
    void display_result(int* totalhr, int* totalmin, int* totalsec) {
...
int main() {
    ...
    timeObj.calculation_part(&hr1, &min1, &sec1, &hr2, &min2, &sec2, &totalhr, &totalmin, &totalsec);
    timeObj.display_result(&totalhr, &totalmin, &totalsec);
